 ...
 */
export function testSelector (element: Element, selector: CssSelector, root: ParentNode = document) {
 ...
 */
export function getParents (element: Element, root = getRootNode(element)) {
 ...
 */
export function *generateParents (element: Element, root: ParentNode = getRootNode(element)) {
  let parent = element;
 ...
 */
export function getRootNode (element: Element) {
